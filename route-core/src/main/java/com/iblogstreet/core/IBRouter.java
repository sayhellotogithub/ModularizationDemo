...
import com.iblogstreet.annotation.model.RouteMeta;
import com.iblogstreet.core.callback.NavigationCallback;
import com.iblogstreet.core.exception.NoRouteFoundException;
import com.iblogstreet.core.template.IRouteGroup;
import com.iblogstreet.core.template.IRouteRoot;
import com.iblogstreet.core.template.IService;
import com.iblogstreet.core.utils.ClassUtils;
...
public class IBRouter {
    private static final String TAG = "IBRouter";
    private static final String ROUTE_ROOT_PAKCAGE = "com.iblogstreet.route.routes";
    private static final String SDK_NAME = "IBRouter";
    private static final String SEPARATOR = "$$";
    private static final String SUFFIX_ROOT = "Root";
    private static Application mContext;

    private static IBRouter instance;
    ...
    public static IBRouter getInstance() {
        synchronized (IBRouter.class) {
            if (instance == null) {
                instance = new IBRouter();
            }
        }
        return instance;
    }
